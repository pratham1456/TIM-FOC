...
def material_defect(image_path):
    ...
    for cnt in contours:
        ...
        defect_area = hull_area - cnt_area

        if defect_area >= 5:  # Threshold for defect detection
            has_defect = True
...
# roi, defect_name = material_defect(r"D:\rahul_jadhav\OneDrive - Percepta Innovations\Projects\TIM\Dataset\9_06_25\big_curve_light\material_defect\VCXU.2-201C.R\image0000373.bmp")
